...
<head>
    ...
    <title>SIKEPIK Registrasi</title>
</head>
<body class="min-h-screen bg-[#0C1E3C] flex items-center justify-center relative">
    <!-- Back to Login Button -->
    <button onclick="window.location.href='{{ route('login') }}'" class="absolute top-4 left-4 bg-gray-800 text-white py-2 px-4 rounded-full focus:outline-none hover:bg-gray-700">
        Kembali
    </button>
    ...
    <script>
        function handleSubmit() {
            ...
            if (!name || !email || !phone || !address || !gender || !password || !repassword) {
                alert("Tolong lengkapi semua data yang diperlukan.");
                return;
            }
