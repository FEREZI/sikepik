...
<body class="bg-gray-100">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside class="w-1/4 bg-gray-800 text-white h-full flex flex-col">
            <div class="p-6">
            ...
            <nav class="mt-4 overflow-y-auto flex-grow">
                ...
                <div class="py-2 px-4">
                    ...
                    <a href="" class="block pl-4 py-1 hover:bg-gray-700">Tabel Kategori Mobil</a>
                    <a href="" class="block pl-4 py-1 hover:bg-gray-700">Tambah Kategori Mobil</a>
                </div>
                <div class="py-2 px-4">
        ...
        <!-- Main Content -->
        <main class="flex-1 p-8 flex justify-center items-center h-screen">
            <h1 class="text-4xl font-semibold">SELAMAT DATANG ADMIN!</h1>
          </main>          
    </div>
</body>
</html>
