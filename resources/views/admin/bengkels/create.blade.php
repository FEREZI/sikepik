...
<body class="bg-gray-100 p-6">
    <div class="form-container">
        <h1 class="form-title">Form Tambah Bengkel</h1>
        <form action="{{ route('admin.bengkels.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="button-container">
                ...
                <a href="{{ route('admin.drivers.index') }}" class="back-button">Kembali</a>
            </div>
        </form>
    </div>
</body>
